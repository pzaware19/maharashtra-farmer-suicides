...
source(file.path(CODDIR, "A3_collect.R"))
source(file.path(CODDIR, "A5_collect.R"))
source(file.path(CODDIR, "B1_clean.R"))
source(file.path(CODDIR, "C1_figures.R"))
source(file.path(CODDIR, "C2_figures.R"))
source(file.path(CODDIR, "C3_figures.R"))
source(file.path(CODDIR, "D1_regression.R"))
source(file.path(CODDIR, "D2_input_costs.R"))
